                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <div class="input-group input-group-dynamic mb-4">
                                    ...
                                    <input type="number" step=".01" class="form-control" aria-label="Amount (to the nearest dollar)" name="original_price" value="{{ old('original_price') }}">
                                </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <div class="input-group input-group-dynamic mb-4">
                                    <span class="input-group-text">{{ $config->currency_simbol }}</span>
                                    <input type="number" step=".01" class="form-control" aria-label="Amount (to the nearest dollar)" name="selling_price" value="{{ old('selling_price') }}">
                                </div>
